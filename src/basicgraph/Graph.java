...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		degSeq.sort(Comparator.reverseOrder());
		return degSeq;
	}
	...
	public static void main (String[] args) {
		...
		System.out.println("Testing 2 hops using AdjList - uscd.map");
		for (int i=0; i < graphFromFile.getNumVertices(); i++) {
			System.out.println("Vertice " + i + ":"); 
		    System.out.println("Neighbor  : " + graphFromFile.getNeighbors(i));
		    System.out.println("2 hops    : " + graphFromFile.getDistance2(i));
		}
		
		System.out.println("Testing 2 hops using AdjMatrix - ucsd.map");
		GraphAdjMatrix mgraphFromFile = new GraphAdjMatrix();
		GraphLoader.loadRoadMap("data/maps/ucsd.map", mgraphFromFile);
		System.out.println(mgraphFromFile);
		for (int i=0; i < graphFromFile.getNumVertices(); i++) {
			System.out.println("Vertice " + i + ":"); 
		    System.out.println("Neighbor  : " + graphFromFile.getNeighbors(i));
		    System.out.println("2 hops    : " + graphFromFile.getDistance2(i));
		...
		System.out.println("Testing 2 hops using AdjList - airportGraph");
		System.out.println("Vertice 0: " + airportGraph.getDistance2(0).toString());
		System.out.println("Vertice 1: " + airportGraph.getDistance2(1).toString());
		System.out.println("Vertice 2: " + airportGraph.getDistance2(2).toString());
		System.out.println("Vertice 3: " + airportGraph.getDistance2(3).toString());
		System.out.println("Vertice 4: " + airportGraph.getDistance2(4).toString());
		System.out.println("Vertice 5: " + airportGraph.getDistance2(5).toString());

 		GraphAdjMatrix mairportGraph = new GraphAdjMatrix();
		GraphLoader.loadRoutes("data/airports/routesUA.dat", mairportGraph);
		System.out.println(mairportGraph);
		System.out.println("Testing 2 hops using AdjMatrix - airportGraph");
		System.out.println("Vertice 0: " + mairportGraph.getDistance2(0).toString());
		System.out.println("Vertice 1: " + mairportGraph.getDistance2(1).toString());
		System.out.println("Vertice 2: " + mairportGraph.getDistance2(2).toString());
		System.out.println("Vertice 3: " + mairportGraph.getDistance2(3).toString());
		System.out.println("Vertice 4: " + mairportGraph.getDistance2(4).toString());
		System.out.println("Vertice 5: " + mairportGraph.getDistance2(5).toString());
